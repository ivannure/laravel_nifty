                                        ...
                                        <div class="d-grid gap-2 ps-5 pe-2">
                                            <div class="row g-1 rounded-3 overflow-hidden">
                                                <div class="col-6 mt-0">
                                                    <img class="img-fluid" src="{{asset('assets/img/megamenu/img-1.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6 mt-0">
                                                    <img class="img-fluid" src="{{asset('assets/img/megamenu/img-3.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('assets/img/megamenu/img-2.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('assets/img/megamenu/img-4.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('assets/img/megamenu/img-6.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                                <div class="col-6">
                                                    <img class="img-fluid" src="{{asset('assets/img/megamenu/img-5.jpg')}}" alt="thumbnails" loading="lazy">
                                                </div>
                                            </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-300px">
                                ...
                                <div class="list-group list-group-borderless">
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex align-items-start mb-3">
                                        <div class="flex-shrink-0 me-3">
                                            <img class="img-xs rounded-circle" src="{{asset('assets/img/profile-photos/3.png')}}" alt="Profile Picture" loading="lazy">
                                        </div>
                                        <div class="flex-grow-1 ">
