                ...
                <div class="content__wrap">
                    ...
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <form class="mt-4" action="https://themeon.net/nifty/v3.0.1/front-pages/password-reminder/index.html">
                            ...
                            <div class="text-center mt-3">
                                <a href="/auth/login" class="btn-link text-decoration-none">Back to login</a>
                            </div>
