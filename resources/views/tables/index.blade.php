                    ...
                    <div class="row">
                            ...
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-title">
                                        <a class="h5 btn-link" href="static-tables/index.html">Static Tables</a>
                                    </div>
                                    <p class="text-muted">A table is an arrangement of information or data, …</p>

                                    <div class="mt-auto">
                                        <a class="btn-link" href="static-tables/index.html">Read more ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-title">
                                        <a class="h5 btn-link" href="gridjs/index.html">Gridjs</a>
                                    </div>
                                    <p class="text-muted">A table library that works everywhere</p>

                                    <div class="mt-auto">
                                        <a class="btn-link" href="gridjs/index.html">Read more ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-title">
                                        <a class="h5 btn-link" href="tabulator/index.html">Tabulator</a>
                                    </div>
                                    <p class="text-muted">Interactive Tables and Data Grids for JavaScript.</p>

                                    <div class="mt-auto">
                                        <a class="btn-link" href="tabulator/index.html">Read more ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
